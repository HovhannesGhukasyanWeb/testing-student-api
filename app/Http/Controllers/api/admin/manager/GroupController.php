...
class GroupController extends ApiCrudController implements ApiCrudInterface
{
    ...
    protected $allowedIncludes = ['parent', 'teacher', 'groupType', 'groupUsers', 'groupUsers.user', 'groupTeacherSubject', 'groupTeacherSubject.teacher', 'groupTeacherSubject.subject'];
